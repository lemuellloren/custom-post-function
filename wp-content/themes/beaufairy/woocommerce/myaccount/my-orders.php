...
if ( $customer_orders ) : ?>
	...
	<table class="table table-striped shop_table shop_table_responsive my_account_orders">
						...
						<?php
							...
							if ( $actions ) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="btn bf-btn bf-btn--violet ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
								}
							}
						?>
					</td>
