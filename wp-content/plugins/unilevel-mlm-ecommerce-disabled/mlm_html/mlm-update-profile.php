...
{ 
	...
	if(isset($_POST['submit']))
	{
		...
		if(empty($error))
		{
				...
				$countryname = $wpdb->get_var("SELECT name FROM {$table_prefix}mlm_country WHERE id = '".$country."'");
				...
				update_user_meta( $user_id, 'user_country', $countryname, FALSE );
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<form name="frm" method="post" action="" onSubmit="return updateFormValidation();">
		...
		<tr>
			<td><?php  _e('Address Line 1',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php  _e('Address Line 2',MLM_PLUGIN_NAME);?> :</td>
		...
		<tr>
			<td><?php  _e('City',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php  _e('State',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php  _e('Postal Code',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php  _e('Country',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
			<td>
				<?php
					$sql = $wpdb->get_results("SELECT id, name
		...
		<tr>
			<td><?php  _e('Contact No',MLM_PLUGIN_NAME);?>. <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php  _e('Date of Birth',MLM_PLUGIN_NAME);?> <span style="color:red;">*</span> :</td>
